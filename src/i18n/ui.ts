...
export const ui = {
  en: {
    ...
    "home.intro": "I'm Arthur, a backend developer working mostly with the JVM. These are the notes I keep while figuring things out.",
    "home.tagline": "Mostly the JVM, databases, Linux and DevOps — plus whatever else comes up along the way.",
  ...
  ru: {
    ...
    "home.intro": "Меня зовут Артур, я backend-разработчик и работаю в основном с JVM. Здесь — заметки, которые я веду, пока сам во всём разбираюсь.",
    "home.tagline": "В основном JVM, базы данных, Linux и DevOps — и всё остальное, что попадается по пути.",
