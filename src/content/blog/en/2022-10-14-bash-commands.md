...
description: "A cheat sheet for commands I use often: find with filters, switching the Java version in Git Bash, connecting to PostgreSQL via psql."
pubDate: 2022-10-14
lang: en
translationId: bash-commands
tags:
  - Bash
  - Linux
  - Terminal
